...
using System.Text;
using static TIMSDK.TIMGlobal;

namespace TIMSDK.api.Core.Client
{
    public static class TIMClientAPI
    {
        #region api
        #region 初始化相关
        /// <summary>
        ...
        public static extern int TIMInit(ulong sdk_app_id, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))] string json_sdk_config);
        /// <summary>
        /// IM SDK 卸载
        /// </summary>
        /// <returns>TIMResult TIM_SUCC 表示成功</returns>
        ...
        public static extern string TIMGetSDKVersion();
        #endregion
        ...
        public static extern int TIMConvCreate([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string conv_id, TIMConvType conv_type, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 删除会话
        /// </summary>
        ...
        public static extern int TIMMsgSendNewMsg([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string conv_id, TIMConvType conv_type,
        ...
        public static extern int TIMMsgReportReaded([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string conv_id, TIMConvType conv_type,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_msg_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 消息撤回
        /// </summary>
        ...
        public static extern int TIMMsgRevoke([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string conv_id, TIMConvType conv_type,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_msg_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 根据消息定位精准查找指定会话的消息。
        /// </summary>
        ...
        public static extern int TIMMsgImportMsgList([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string conv_id, TIMConvType conv_type,
        ...
        public static extern int TIMMsgSaveMsg([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string conv_id, TIMConvType conv_type,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_msg_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 获取指定会话的消息列表。
        ...
        public static extern int TIMMsgDelete([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string conv_id, TIMConvType conv_type,
        ...
        public static extern int TIMGroupCreate([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_group_create_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 删除（解散）群组
        /// 对于私有群，任何人都无法解散群组。
        ...
        public static extern int TIMGroupDelete([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string group_id, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 申请加入群组
        /// </summary>
        ...
        public static extern int TIMGroupJoin([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string group_id,
        ...
        public static extern int TIMGroupGetGroupInfoList([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_group_getinfo_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 修改群信息
        /// </summary>
        ...
        public static extern int TIMGroupModifyGroupInfo([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_group_modifyinfo_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 获取群成员信息列表
        /// </summary>
        ...
        public static extern int TIMGroupGetMemberInfoList([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_group_getmeminfos_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 修改群成员信息
        /// </summary>
        ...
        public static extern int TIMGroupReportPendencyReaded(ulong time_stamp, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 处理群未决信息
        /// </summary>
        ...
        public static extern int TIMFriendshipAddFriend([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_add_friend_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 处理好友请求
        /// </summary>
        ...
        public static extern int TIMFriendshipModifyFriendProfile([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_modify_friend_info_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 删除好友
        /// </summary>
        ...
        public static extern int TIMFriendshipDeleteFriend([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_delete_friend_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 检测好友类型（单向或双向）
        /// </summary>
        ...
        public static extern int TIMFriendshipCreateFriendGroup([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_create_friend_group_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 获取指定好友分组的分组信息。
        /// </summary>
        ...
        public static extern int TIMFriendshipGetFriendGroupList([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_get_friend_group_list_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 修改好友分组
        /// </summary>
        ...
        public static extern int TIMFriendshipDeleteFriendGroup([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_delete_friend_group_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 添加指定用户到黑名单
        /// </summary>
        ...
        public static extern int TIMFriendshipGetPendencyList([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_get_pendency_list_param, TIMCommCallback cb, IntPtr user_data);
        /// <summary>
        /// 删除指定好友添加请求未决信息
        /// </summary>
        ...
        public static extern void TIMSetNetworkStatusListenerCallback(TIMSetNetworkStatusListenerCallback cb, IntPtr user_data);
        /// <summary>
        /// 设置被踢下线通知回调
        /// </summary>
        ...
        public static extern void TIMUpdateFriendProfileCallback(TIMUpdateFriendProfileCallback cb, IntPtr user_data);
        /// <summary>
        /// 设置好友添加请求的回调
        /// </summary>
